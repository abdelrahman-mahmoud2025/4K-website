          ...
          filteredDownloads.map((file, index) => (
            ...
            >
              <div className="flex items-center gap-5 w-full min-w-0">
                <div className="bg-background p-4 rounded-xl text-primary border border-border group-hover:scale-110 transition-transform duration-300 shrink-0">
                  <FileText size={28} />
                </div>
                <div className="min-w-0 flex-1">
                  <h4 className="text-lg md:text-xl font-bold text-text mb-1 group-hover:text-primary transition-colors truncate">
                    {file.fileName}
                  </h4>
                  <div className="flex flex-wrap gap-x-4 gap-y-2 text-sm text-subtext">
                    <span className="flex items-center gap-1 bg-background px-2 py-0.5 rounded border border-border/50 truncate max-w-full">
